...
#if defined(NDEBUG)
# error "Moneta cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Moneta Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Moneta: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
    ...
    if (block.nVersion < 2)
    {
        ...
        {
            // Regtest and Unittest: use Moneta's supermajority rule
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Moneta: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
